...
var debug = require('debug')('imock:server:datasets')
...
router.get('/', function (req, res, next) {
	...
	// MOCK - GET REST
	var _service = {
		name: '/imock/INBound/OUTBound/REST_GET',
		pseudo: 'imock unit tests',
		group: 'imock',
		key1: 'id',
		//      key2: 'key2',
	...
	// MOCK - POST REST
	_service = {
		name: '/imock/INBound/OUTBound/REST_POST',
		pseudo: 'imock unit tests',
		group: 'imock',
		key1: 'credentials.id',
		body: '{"data":{"id":0,"first_name":"foo","last_name":"bar","Label":""}}',
	...
	client.hmset(_service.name, _service)
	_response = {
		name: '/imock/INBound/OUTBound/REST_POST/3',
		body: '{"data":{"id":3,"first_name":"Isaac","last_name":"Asimov","Label":"HAL-<!\\d{9}!>"}}'
	}
	client.hmset(_response.name, _response)
	_response = {
		name: '/imock/INBound/OUTBound/REST_POST/4',
	...
	// MOCK - SOAP
	_service = {
		name: '/imock/INBound/OUTBound/SOAP',
		pseudo: 'imock unit tests',
		group: 'imock',
		key1: 'id',
	...
	client.hmset(_service.name, _service)
	_response = {
		name: '/imock/INBound/OUTBound/SOAP/5',
	...
	client.hmset(_response.name, _response)
	_response = {
		name: '/imock/INBound/OUTBound/SOAP/6',
	...
	var _service = {
		...
		group: 'imock',
		real: 1,
		producers: 'http://192.168.56.102:8080/imock'
	}
	client.hmset(_service.name, _service)
